...
@overload
def invalidOption(answer: Any, animation: bool) -> None: ...
@overload
def invalidOption(system: str, animation: bool) -> None : ...
@overload
def invalidOption(delay: bool) -> None : ...
@overload
def invalidOption(animation: bool, delay: bool) -> None : ...
@overload
def invalidOption(answer: Any, delay: bool) -> None: ...
@overload
def invalidOption(system: str, delay: bool) -> None : ...
@overload
def invalidOption(answer: Any, animation: bool, delay: bool) -> None: ...
@overload
def invalidOption(system: str, animation: bool, delay: bool) -> None : ...
@logC()
def invalidOption(
        *args,
